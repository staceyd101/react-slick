...
import { AccessibilityInstructions, AccessibilityAutoPlayToggle } from './accessibility/accessiblity-components';
...
export class InnerSlider extends React.Component {
  ...
  onHandleAccessibilityAutoPlayToggle = () => 
    this.props.autoplay &&
    this.state.autoplaying === 'playing' 
      ? this.pause("paused")
      : this.autoPlay();
  render = () => {
    ...
    const { pauseOnHover, accessibility } = this.props;
    trackProps = {
      ...trackProps,
      ...
      showAccesibilityRole: accessibility && spec.useGroupRole,
      accesibilityRegion: accessibility && this.props.regionLabel
    };
